...
def build_review_pr_body(
    ...
    *,
    ...
    if review_kind not in {"candidate", "source_state"}:
    ...
    if review_kind == "source_state":
        heading = "# Source State Refresh"
        intro = "This draft PR was generated after official-source fingerprints changed without new review candidates."
    else:
        heading = "# Candidate Review"
        intro = "This draft PR was generated by the deterministic official-source refresh workflow."
