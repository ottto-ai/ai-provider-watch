...
def test_operations_report_matches_schema_and_current_public_gaps() -> None:
    ...
    assert report["summary"]["reviewed_event_count"] == 67
    assert report["summary"]["latest_event_date"] == "2026-06-16"
    ...
    assert report["summary"]["source_state_latest_retrieved_at"] == "2026-06-17T02:17:31Z"
